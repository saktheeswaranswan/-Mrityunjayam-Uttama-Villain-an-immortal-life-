...
mask_image = cv2.imread('fff.png', cv2.IMREAD_UNCHANGED)
...
while True:
    ...
    if landmarks:
        # Overlay the face mask on the detected face
        frame = overlay_mask_on_face(frame, mask_image, landmarks[0].landmark)
